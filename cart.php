                        ...
                        <li>
                            ...
                            <ul class="mobile-sub-menu">
                                ...
                                <li>
                                    ...
                                    <ul class="mobile-sub-menu">
                                        <li><a href="blog.php">Blog Single Sidebar left</a></li>
                                ...
                                <table>
                                    ...
                                    <tbody>
                                        ...
                                        <?php foreach ($_SESSION["keranjang"] as $id_produk => $jumlah) : ?>
                                            ...
                                            <tr>
                                                <td class="product_no"><?php echo $nomor; ?></td>
                                                <td class="product_remove"><a href="hapuskeranjang.php?id=<?php echo $id_produk ?>"><i class="fa fa-trash-o"></i></a>
                                                </td>
                                                <td class="product_thumb"><a href="product-details-default.php"><img src="foto_produk/<?php echo $pecah['foto_produk']; ?>" alt=""></a></td>
                                                <td class="product_name"><a href="product-details-default.php"><?php echo $pecah["nama_produk"]; ?></a></td>
                                                <td class="product-price"><?php echo number_format($pecah["harga_produk"]); ?></td>
                                                <td class="product_quantity"><?php echo $jumlah; ?></td>
                                                <td class="product_total">Rp. <?php echo number_format($subharga); ?></td>
                                            </tr>
                                            <?php $nomor++; ?>
                                        <?php endforeach ?>
                                    </tbody>
                    ...
                    <div class="row justify-content-between align-items-center align-items-center flex-column flex-md-row mb-n6">
                        <div class="col-auto mb-6">
                            <div class="footer-copyright">
                                <p class="copyright-text">&copy; 2021 <a href="index.php">therankme</a>. Made with <i class="fa fa-heart text-danger"></i> by <a href="https://therankme.com/" target="_blank">therankme</a> </p>
...
<?php
// Pastikan ini adalah tempat yang tepat untuk mengakses database dan fungsi lain yang diperlukan
// Periksa apakah ada permintaan POST yang dikirim dari klien
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    // Periksa apakah ID produk telah dikirim melalui permintaan POST
    if (isset($_POST['id_produk'])) {
        // Ambil ID produk dari permintaan POST
        $id_produk = $_POST['id_produk'];

        // Lakukan proses tambah ke keranjang belanja di sini
        // Misalnya, simpan ID produk ke dalam sesi atau database

        // Berikan tanggapan sukses kepada klien
        http_response_code(200); // Beri kode respons 200 (OK)
        echo json_encode(array("message" => "Produk berhasil ditambahkan ke keranjang."));
    } else {
        // Jika ID produk tidak tersedia dalam permintaan POST, kirim tanggapan error ke klien
        http_response_code(400); // Beri kode respons 400 (Bad Request)
        echo json_encode(array("message" => "ID produk tidak diterima."));
    }
} else {
    // Jika bukan permintaan POST, kirim tanggapan error ke klien
    http_response_code(405); // Beri kode respons 405 (Method Not Allowed)
    echo json_encode(array("message" => "Metode yang dilarang."));
}
?>
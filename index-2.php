            ...
            <div class="swiper-wrapper">
                ...
                <div class="hero-single-slider-item swiper-slide">
                    ...
                    <div class="hero-slider-bg">
                        <img src="assets/images/banner/puffy.png" alt="">
                    </div>
                    <!-- Hero Slider Content -->
                            ...
                            <div class="swiper-container product-default-slider-4grid-1row">
                                ...
                                <div class="swiper-wrapper">
                                    ...
                                    <div class="product-default-single-item product-color--green swiper-slide">
                                        <div class="image-box">
                                            <a href="produkdetail.php" class="image-link">
                                        ...
                                        <div class="content">
                                            <div class="content-left">
                                                <h6 class="title"><a href="produkdetail.php">Epicuri per
                                                        lobortis</a></h6>
                                    ...
                                    <div class="product-default-single-item product-color--green swiper-slide">
                                        ...
                                        <div class="content">
                                            <div class="content-left">
                                                <h6 class="title"><a href="produkdetail.php">Kaoreet
                                                        lobortis sagit</a></h6>
                                                <ul class="review-star">
                                                    <li class="fill"><i class="ion-android-star"></i></li>
                                                    <li class="fill"><i class="ion-android-star"></i></li>
                                    ...
                                    <div class="product-default-single-item product-color--green swiper-slide">
                                        ...
                                        <div class="content">
                                            <div class="content-left">
                                                <h6 class="title"><a href="produkdetail.php">Condimentum
                                                        posuere</a></h6>
                                                <ul class="review-star">
                                                    <li class="fill"><i class="ion-android-star"></i></li>
                                                    <li class="fill"><i class="ion-android-star"></i></li>
                                    ...
                                    <div class="product-default-single-item product-color--green swiper-slide">
                                        ...
                                        <div class="content">
                                            <div class="content-left">
                                                <h6 class="title"><a href="produkdetail.php">Convallis quam
                                                        sit</a></h6>
                                                <ul class="review-star">
                                                    <li class="fill"><i class="ion-android-star"></i></li>
                                                    <li class="fill"><i class="ion-android-star"></i></li>
                                    ...
                                    <div class="product-default-single-item product-color--green swiper-slide">
                                        ...
                                        <div class="content">
                                            <div class="content-left">
                                                <h6 class="title"><a href="produkdetail.php">Aliquam
                                                        lobortis</a></h6>
                                                <ul class="review-star">
                                                    <li class="fill"><i class="ion-android-star"></i></li>
                                                    <li class="fill"><i class="ion-android-star"></i></li>
                                    ...
                                    <div class="product-default-single-item product-color--green swiper-slide">
                                        ...
                                        <div class="content">
                                            <div class="content-left">
                                                <h6 class="title"><a href="produkdetail.php">Cras neque
                                                        metus</a></h6>
                                                <ul class="review-star">
                                                    <li class="fill"><i class="ion-android-star"></i></li>
                                                    <li class="fill"><i class="ion-android-star"></i></li>
                                    ...
                                    <div class="product-default-single-item product-color--green swiper-slide">
                                        ...
                                        <div class="content">
                                            <div class="content-left">
                                                <h6 class="title"><a href="produkdetail.php">Donec eu libero
                                                        ac</a></h6>
                                                <ul class="review-star">
                                                    <li class="fill"><i class="ion-android-star"></i></li>
                                                    <li class="fill"><i class="ion-android-star"></i></li>
                            ...
                            <div class="swiper-container product-listview-slider-4grid-3rows">
                                ...
                                <div class="swiper-wrapper">
                                    ...
                                    <div class="product-listview-single-item product-color--green swiper-slide">
                                        ...
                                        <div class="content">
                                            <h6 class="title"><a href="produkdetail.php">Consequuntur
                                                    magni</a></h6>
                                            <ul class="review-star">
                                                <li class="fill"><i class="ion-android-star"></i></li>
                                                <li class="fill"><i class="ion-android-star"></i></li>
                                    ...
                                    <div class="product-listview-single-item product-color--green swiper-slide">
                                        ...
                                        <div class="content">
                                            <h6 class="title"><a href="produkdetail.php">Pellentesque
                                                    posuere</a></h6>
                                            <ul class="review-star">
                                                <li class="fill"><i class="ion-android-star"></i></li>
                                                <li class="fill"><i class="ion-android-star"></i></li>
                                    ...
                                    <div class="product-listview-single-item product-color--green swiper-slide">
                                        ...
                                        <div class="content">
                                            <h6 class="title"><a href="produkdetail.php">Kaoreet lobortis
                                                    sagit</a></h6>
                                            <ul class="review-star">
                                                <li class="fill"><i class="ion-android-star"></i></li>
                                                <li class="fill"><i class="ion-android-star"></i></li>
                                    ...
                                    <div class="product-listview-single-item product-color--green swiper-slide">
                                        ...
                                        <div class="content">
                                            <h6 class="title"><a href="produkdetail.php">Phasellus vel
                                                    hendreri</a></h6>
                                            <ul class="review-star">
                                                <li class="fill"><i class="ion-android-star"></i></li>
                                                <li class="fill"><i class="ion-android-star"></i></li>
                                    ...
                                    <div class="product-listview-single-item product-color--green swiper-slide">
                                        ...
                                        <div class="content">
                                            <h6 class="title"><a href="produkdetail.php">Duis pulvinar
                                                    obortis</a></h6>
                                            <ul class="review-star">
                                                <li class="fill"><i class="ion-android-star"></i></li>
                                                <li class="fill"><i class="ion-android-star"></i></li>
                                    ...
                                    <div class="product-listview-single-item product-color--green swiper-slide">
                                        ...
                                        <div class="content">
                                            <h6 class="title"><a href="produkdetail.php">Officiis debitis
                                                    varius</a></h6>
                                            <ul class="review-star">
                                                <li class="fill"><i class="ion-android-star"></i></li>
                                                <li class="fill"><i class="ion-android-star"></i></li>
                                    ...
                                    <div class="product-listview-single-item product-color--green swiper-slide">
                                        ...
                                        <div class="content">
                                            <h6 class="title"><a href="produkdetail.php">Ornare sed
                                                    consequat</a></h6>
                                            <ul class="review-star">
                                                <li class="fill"><i class="ion-android-star"></i></li>
                                                <li class="fill"><i class="ion-android-star"></i></li>
                                    ...
                                    <div class="product-listview-single-item product-color--green swiper-slide">
                                        ...
                                        <div class="content">
                                            <h6 class="title"><a href="produkdetail.php">Dolorum fuga
                                                    eget</a></h6>
                                            <ul class="review-star">
                                                <li class="fill"><i class="ion-android-star"></i></li>
                                                <li class="fill"><i class="ion-android-star"></i></li>
                                    ...
                                    <div class="product-listview-single-item product-color--green swiper-slide">
                                        ...
                                        <div class="content">
                                            <h6 class="title"><a href="produkdetail.php">Nostrum
                                                    exercitation</a></h6>
                                            <ul class="review-star">
                                                <li class="fill"><i class="ion-android-star"></i></li>
                                                <li class="fill"><i class="ion-android-star"></i></li>
                                    ...
                                    <div class="product-listview-single-item product-color--green swiper-slide">
                                        ...
                                        <div class="content">
                                            <h6 class="title"><a href="produkdetail.php">Laudantium enim
                                                    fringi</a></h6>
                                            <ul class="review-star">
                                                <li class="fill"><i class="ion-android-star"></i></li>
                                                <li class="fill"><i class="ion-android-star"></i></li>

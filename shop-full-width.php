                                    ...
                                    <div class="tab-content">
				                            ...
				                            <?php while($perproduk = $ambil->fetch_assoc()){ ?>
                                                <div class="col-xl-3 col-lg-4 col-sm-6 col-12">
                                                    ...
                                                    <div class="product-default-single-item product-color--golden"
                                                        data-aos="fade-up" data-aos-delay="0">
                                                        <div class="image-box">
                                                            <a href="produkdetail.php?id_produk=<?php echo $perproduk['id_produk'];?>"class="image-link">
                                                            <img src="foto_produk/<?php echo $perproduk['foto_produk'];?>" alt="">
                                                            </a>
                                                            <div class="action-link">
                                                                <div class="action-link-left">
                                                                    <a href="beli.php?id=<?php echo $perproduk['id_produk'];?>">Add to Cart</a>
                                                                </div>
                                                                <div class="action-link-right">
                                                                    <a href="#" data-bs-toggle="modal"
                                                                        data-bs-target="#modalQuickview"><i
                                                                            class="icon-magnifier"></i></a>
                                                                    <a href="wish.php?id=<?php echo $perproduk['id_produk'];?>"><i
                                                        ...
                                                        <div class="content">
                                                            <div class="content-left">
                                                                <h6 class="title"><a href="produkdetail.php?id_produk=<?php echo $perproduk['id_produk'];?>"class="image-link"><?php echo $perproduk['nama_produk'];?></a></h6>
                                                            ...
                                                            <div class="content-right">
                                                                <span class="price">Rp.<?php echo number_format($perproduk['harga_produk']);?></span>
                                                            </div>
                                                        </div>
                                                    </div>
                                        ...
                                        <div class="tab-pane sort-layout-single" id="layout-list">
				                            ...
				                            <?php while($perproduk = $ambil->fetch_assoc()){ ?>
                                                    ...
                                                    <a href="produkdetail.php?id_produk=<?php echo $perproduk['id_produk'];?>"class="product-list-img-link" style ="width:500px; margin-bottom:30px">
                                                            <img class="img-fluid"
                                                            src="foto_produk/<?php echo $perproduk['foto_produk'];?>"alt="">
                                                    </a>
                                                        <div class="product-list-content">
                                                        <h5 class="title"><a href="produkdetail.php?id_produk=<?php echo $perproduk['id_produk'];?>"class="image-link"><?php echo $perproduk['nama_produk'];?></a></h5>
                                                            <ul class="review-star">
                                                            ...
                                                            <span class="product-list-price"><?php echo $perproduk['harga_produk'];?></span>
                                                            <p><?php echo $perproduk['deskripsi_produk'];?></p>
                                                            <div class="product-action-icon-link-list">
                                                                <a href="beli.php?id=<?php echo $perproduk['id_produk'];?>" class="btn btn-lg btn-black-default-hover">Add to
                                                                    cart</a>
                                                                <a href="#" data-bs-toggle="modal"
                    ...
                    <div
                        ...
                        <div class="col-auto mb-6">
                            <div class="footer-copyright">
                                <p class="copyright-text">&copy; 2021 <a href="index-2.php">therankme</a>. Made with <i
